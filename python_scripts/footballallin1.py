...
# This script was design to scrape all european
# football table results and add them to a csv file.
# I am current learning more about pandas to apply
# this data to a postgresql database using django model.
...
def futbol_index():
    ...
    for pag, leag in zip(page, league):
        ...
        contents = soup.find_all('tr', attrs={'class':
                                 re.compile('standing-table__row')})
        for content in contents:
            ...
            last_df.to_csv('{0}.csv'.format(leag),
